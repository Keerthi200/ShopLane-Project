...
function getProductDetail() {
    ...
    // Get Product Details
    $.get("https://5d76bf96515d1a0014085cf9.mockapi.io/product/" + searchId,
        function (data) {
            var productDetail = data;
            let name = productDetail.name;
            let imageSrc = productDetail.preview;
            let brand = productDetail.brand;
            let price = productDetail.price;
            let description = productDetail.description;
            let photo0 = productDetail.photos[0];
            let photo1 = productDetail.photos[1];
            let photo2 = productDetail.photos[2];
            let photo3 = productDetail.photos[3];
            let photo4 = productDetail.photos[4];
            let photo5 = productDetail.photos[5];
